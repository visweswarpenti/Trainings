...
namespace DataStructures.DoubleLinkedListProj.Tests
{
    public class DoubleLinkedListDemoSpec
    {
        DoubleLinkedListDemo _testObject = new();
        ...
        [Fact]
        public void DisplayReverseOrder_ShouldDisplayElementsInReverseOrder_When_ElementsArePassedToInsertion()
        {
            _testObject.Insertion(10, 0);
            _testObject.Insertion(20, 1);
            _testObject.Insertion(30, 2);
            ...
            var listElements = _testObject.DisplayReverseOrder();
            Assert.Equal("50,40,30,20,10", string.Join(",", listElements));
        }
